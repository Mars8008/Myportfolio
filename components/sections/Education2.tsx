										...
										<ul className="ps-3">
											{/* <li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">University Of Minnesota</span>
											...
											{/* <li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														...
														<p className="text-dark"> Electronic engiinering </p>
													</div>
												</div>
											</li> */}
											{/* <li className="position-relative z-1 mb-3">
									...
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												<p className="text-300 text-nowrap fw-regular mb-0">2024-2025:</p>
												<div>
													<span className="text-primary-2"> Travel Web Site</span>
													<p className="text-dark">Studied flexible ui design, big data tools for advanced analytics and insights.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												<p className="text-300 text-nowrap fw-regular mb-0">2024-2025:</p>
												<div>
													<span className="text-primary-2">Food Delivery Web Mobile App</span>
													<p className="text-dark">Studied best practices for back-end development.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Fitness portfolio Web Mobile App</span>
