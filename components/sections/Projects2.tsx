													...
													<div className="row">
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															<h4 className="text-linear-4">
																Fitness Trainer Portfolio <br />
															
															</h4>
															<p>Developed a personal website to showcase professional fitness and nutrition services, highlight achievements, and make it easy for clients to connect.
</p>
															<ul className="mt-4 list-unstyled">
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		...
																		<p className="text-300 mb-0 text-end">Fitness Trainer</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
															...
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="https://azkhuu-personal-website.vercel.app" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																...
																<Link href="https://github.com/Mars8008" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="https://github.com" width={24} height={25} viewBox="0 0 24 25" fill="none">
												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<p>This web app simplifies food ordering and automates restaurant order management. Users can browse menus, add items to their cart, place orders,</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">Project Info</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Client</p>
																		<p className="text-300 mb-0 text-end">Little Restaurant</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Technologies</p>
																		<p className="text-300 mb-0 text-end">Node.js, React, MongoDB, TailwindCSS,  </p>
																	</div>
																</li>
															</ul>
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href=" https://tomato-food-delivery-ashy.vercel.app" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13" fill="none">
																		<path d="M11.0037 3.91421L2.39712 12.5208L0.98291 11.1066L9.5895 2.5H2.00373V0.5H13.0037V11.5H11.0037V3.91421Z" fill="#8F8F92" />
																	</svg>
																	Live Demo
												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<p>Visit to Mongolia is a tour booking website designed for foreign travelers. The site allows users to book customized tours based on their preferences and also highlights Mongolia’s rich cultural heritage and traditions.</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">Project Info</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
															...
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="https://www.2mongolia.com/" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13" fill="none">
																		<path d="M11.0037 3.91421L2.39712 12.5208L0.98291 11.1066L9.5895 2.5H2.00373V0.5H13.0037V11.5H11.0037V3.91421Z" fill="#8F8F92" />
																	</svg>
																	Live Demo
